...
func Test_notExtRule(t *testing.T) {
	type args struct {
		name    string
		val     interface{}
		ruleVal string
	...
	tests := []struct {
		...
		{
			name: "test notExtRule with unsuitable data",
			args: args{
				name:    "file",
				val:     &multipart.FileHeader{Filename: "example.json"},
				ruleVal: ".json",
		...
		{
			name: "test notExtRule with non-file val",
			args: args{
				name:    "file",
				val:     "bla bla",
				ruleVal: ".json",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err := notExtRule(tt.args.name, tt.args.val, tt.args.ruleVal); (err != nil) != tt.wantErr {
				t.Errorf("notExtRule() error = %v, wantErr %v", err, tt.wantErr)
			}
		})
	}
}

func Test_extInRule(t *testing.T) {
	type args struct {
		name    string
		val     interface{}
		ruleVal string
	...
	tests := []struct {
		...
		{
			name: "test extInRule with unsuitable data",
			args: args{
				name:    "file",
				val:     &multipart.FileHeader{Filename: "example.md"},
				ruleVal: ".html,.json,.go",
		...
		{
			name: "test extInRule with non-file val",
			args: args{
				name:    "file",
				val:     "bla bla",
				ruleVal: ".json",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err := extInRule(tt.args.name, tt.args.val, tt.args.ruleVal); (err != nil) != tt.wantErr {
				t.Errorf("extInRule() error = %v, wantErr %v", err, tt.wantErr)
			}
		})
	}
}
