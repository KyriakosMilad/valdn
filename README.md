...
| in*             | anything,anything,...             | in:55,somestring,[1 2 3]                                                     | inRule checks if val equals one of ruleVal[] items. <br /> It returns error if val doesn't equal any item in ruleVal[].                                                                                                                                                                                                                                                             |
| notIn*          | anything,anything,...             | notIn:5.4,text,[1 2 3]                                                       | notInRule checks if val doesn't equal any item in ruleVal[]. <br /> It returns error if val equals one of ruleVal[] items.                                                                                                                                                                                                                                                          |
