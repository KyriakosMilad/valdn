...
| type*           | string                            | type:map                                                                     | typeRule checks if val's type equals ruleVal. <br /> It returns error if val's type does not equal ruleVal.                                                                                                                                                                                                                                                                         |
| typeIn*         | string                            | kind:map                                                                     | typeInRule checks if val's type is one of ruleVal[]. <br /> It returns error if val's type is not one of ruleVal[].                                                                                                                                                                                                                                                                 |
| typeNotIn*      | string                            | kind:map                                                                     | typeNotInRule checks if val's type is not one of ruleVal[]. <br /> It returns error if val's type is one of ruleVal[].                                                                                                                                                                                                                                                              |
| equal*          | string                            | equal:something                                                              | kindRule checks if val's kind equals ruleVal. <br /> It returns error if val's kind does not equal ruleVal.                                                                                                                                                                                                                                                                         |
...
| in*             | anything,anything,...             | in:55,somestring,[]int{1,2,3}                                                | inRule checks if val equals one of ruleVal[] items. <br /> It returns error if val doesn't equal any item in ruleVal[].                                                                                                                                                                                                                                                             |
| notIn*          | anything,anything,...             | notIn:5.4,text,[]int{1,2,3}                                                  | notInRule checks if val doesn't equal any item in ruleVal[]. <br /> It returns error if val equals one of ruleVal[] items.                                                                                                                                                                                                                                                          |
